        ...
        <>
            ...
            <div className="col border-bottom">
                <div className="row px-0 justify-content-start">
                    <div className="col-lg-2 col-12 col-sm-6 px-0 align-self-center">
                        <img className="img-fluid" src="https://img.freepik.com/premium-photo/having-great-idea_102671-6148.jpg?w=360" alt='' />
                    </div>
                    <div className="col-lg-10 col-sm-6 align-self-center py-3 py-sm-0">
                        ...
                        <div className='row px-2 align-items-center'>
                            <div className='col-6 col-sm-5  col-md-12 col-lg-6 px-0 py-2 blogs-button'>
                                <Link onClick={scrollToHome} to={`/blogs/Golden-Rules-for-Elevating-Your-Creative-Vision`}>Read More</Link>
                            </div>
                            <div className='col-6 col-sm-7 col-md-12 col-lg-6 text-end py-2 blog-content'>
            ...
            <div className="col border-bottom">
                <div className="row px-0 justify-content-start">
                    ...
                    <div className="col-lg-10 col-sm-6 align-self-center py-3">
                        <div className='row px-2'>
                            <div className='col-sm-12 col-lg-12 col-12 col-md-12 px-0 blog-content'>
            ...
            {/* <div className="col">
                <div className="card">
                    <div className="card-body p-0 shadow blog-box">
                        ...
                        <div className='row px-2 py-3 align-items-center'>
