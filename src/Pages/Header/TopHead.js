          ...
          <div className='row'>
            <div className='col-lg-10 col-md-9 col-sm-12 col-12 align-self-center py-sm-2 py-md-0'>
              <div className='row px-1'>
                <div className='col-lg-8 col-md-6 col-sm-6 col-12 top-Nav-contact px-0 d-flex gap-2 align-items-center justify-content-sm-end justify-content-center'>
                  <i className="fa-solid fa-phone" style={{ color: "#fff" }}></i>
                  <Link to="tel:+91 8427682603"> +91 8427682603</Link>
                </div>
                <div className='col-lg-4 col-md-6 col-sm-6 col-12 top-Nav-contact top-Nav-contact-hide1 d-flex gap-2 align-items-center px-0  justify-content-center'>
                  <i className="fa-solid fa-envelope" style={{ color: "#fff" }}></i>
